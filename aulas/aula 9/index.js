...
// o valor impresso no console será 27
*/
...
/*
const comidas = ["hamburguer" , "pizza" , "macarrão com carne" , "pão de alho" , "churrasco"]
console.log(comidas)
...
const favorita = prompt ("diga uma comida preferida sua")
console.log(favorita.length)
*/
